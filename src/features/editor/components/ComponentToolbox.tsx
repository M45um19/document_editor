...
export function ComponentToolbox() {
  return (
    <aside className="w-52 sm:w-56 lg:w-60 xl:w-64 2xl:w-72 3xl:w-80 bg-[#081225] text-slate-300 flex flex-col justify-between shrink-0 p-3.5 2xl:p-5 select-none border-r border-slate-800 transition-all duration-200">
      {/* Top Section: Components list and quick actions */}
      <div className="space-y-4 2xl:space-y-6">
        <div>
          <h2 className="text-xs 2xl:text-sm font-bold text-slate-200 uppercase tracking-wider mb-2.5 2xl:mb-3.5 px-1">
            Components
          </h2>
          ...
          <nav className="space-y-1 2xl:space-y-1.5">
            ...
            >
              <MousePointer2 className="w-4 h-4 2xl:w-4.5 2xl:h-4.5 fill-white" />
              <span>Select</span>
            </button>
            ...
            >
              <Type className="w-4 h-4 2xl:w-4.5 2xl:h-4.5 text-slate-400" />
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 2xl:gap-3 px-3 2xl:px-4 py-2 2xl:py-2.5 rounded-lg text-slate-300 hover:text-white hover:bg-slate-800/60 text-xs 2xl:text-sm font-medium transition"
            >
              <TableIcon className="w-4 h-4 2xl:w-4.5 2xl:h-4.5 text-slate-400" />
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 2xl:gap-3 px-3 2xl:px-4 py-2 2xl:py-2.5 rounded-lg text-slate-300 hover:text-white hover:bg-slate-800/60 text-xs 2xl:text-sm font-medium transition"
            >
              <ImageIcon className="w-4 h-4 2xl:w-4.5 2xl:h-4.5 text-slate-400" />
              <span>Image</span>
            </button>
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 2xl:gap-3 px-3 2xl:px-4 py-2 2xl:py-2.5 rounded-lg text-slate-300 hover:text-white hover:bg-slate-800/60 text-xs 2xl:text-sm font-medium transition"
            >
              <Shapes className="w-4 h-4 2xl:w-4.5 2xl:h-4.5 text-slate-400" />
              <span>Shape</span>
            </button>
          </nav>
        </div>
        ...
        <div className="space-y-2 2xl:space-y-2.5 pt-1">
          ...
          >
            <Plus className="w-3.5 h-3.5 2xl:w-4 2xl:h-4 text-slate-400" />
      ...
      <div className="pt-4 2xl:pt-6 border-t border-slate-800/80 space-y-2.5 2xl:space-y-3.5">
